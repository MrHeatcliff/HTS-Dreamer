...
| UT-09 | far-negative modes none/hard/soft | PASS |  |
...
| UT-13D | detached synthetic linear probe path | XFAIL | Synthetic trainer/evaluator deferred |
| UT-14 | synthetic evaluation labels excluded from training | XFAIL | Synthetic path deferred |
| UT-15-MATRIX | component matrix V6 typed parity | PASS |  |
| UT-15-P0 | all P0 one-step smoke rows | PASS |  |
| UT-15-P1 | P1 optional controls | XFAIL | larger_flat_flops remains P1 |
| IT-01 | tiny synthetic shard overfit | XFAIL | Synthetic path deferred |
| IT-02 | synthetic checkpoint evaluator | XFAIL | Synthetic path deferred |
| IT-03 | short Atari smoke complete artifacts | XFAIL | Periodic eval integration deferred |
| IT-04 | periodic evaluation state isolation | XFAIL | Periodic eval integration deferred |
| IT-05 | checkpoint resume preserves optimizer/config | XFAIL | Resume integration deferred |
