...
Debug smoke covered construct, compile, checkpoint save, and training-loop entry. Full forward/backward/optimizer/checkpoint-reload assertions for every P0 row remain tracked as Gate A2 regression work.
